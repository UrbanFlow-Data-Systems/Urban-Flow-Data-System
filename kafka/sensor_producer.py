...
SENSORS = [
    {
        'sensor_id': 'SENSOR_JUNCTION_1',
        'base_vehicle_count': 45,
        'base_speed': 35
    },
    {
        'sensor_id': 'SENSOR_JUNCTION_2',
        'base_vehicle_count': 38,
        'base_speed': 40
    },
    {
        'sensor_id': 'SENSOR_JUNCTION_3',
        'base_vehicle_count': 52,
        'base_speed': 30
    },
    {
        'sensor_id': 'SENSOR_JUNCTION_4',
...
class TrafficDataGenerator:
    ...
    def __init__(self):
        self.congestion_probability = 0.40  # 10% chance of congestion per sensor
    ...
    def should_trigger_congestion(self, sensor_id):
        return random.random() < self.congestion_probability
...
def main():
    ...
    logger.info(f"Congestion Probability: 10% per reading")
    logger.info("=" * 80)
